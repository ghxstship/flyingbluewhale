...
**Status:** canonical · **Applies to:** `flyingbluewhale` (ATLVS Technologies) · **Authority:** user-confirmed 2026-05-09
...
- **In-scope subsystems** (ATLVS-native list per [docs/XPMS_TO_ATLVS_MAPPING.md](XPMS_TO_ATLVS_MAPPING.md))
