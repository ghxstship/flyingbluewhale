# GVTEWAY (portal) — Workforce-parity audit

Date: 2026-05-11
Scope: `src/app/(portal)/p/[slug]/<persona>/*` — 18 personas, 91 pages.
Source: the deskless-workforce suite taxonomy as applied to COMPVSS (`docs/runbooks/connecteam-ops.md`).

## Audience translation

the deskless-workforce suite targets internal deskless workforce. GVTEWAY targets EXTERNAL
counterparts of an internal org — delegates, vendors, sponsors, guests,
press, talent agents. Not every the deskless-workforce suite feature maps; some
...
## Out of scope (not the deskless-workforce suite analogues for the portal)
