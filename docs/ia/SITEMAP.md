...
**Page routes:** 1197 · **API route handlers:** 151 · **Distinct nav hrefs:** 523
...
| COMPVSS — Field PWA | mobileTabs / mobileSurfaces | 59 | 44 | 14 | 0 | 1 |
...
59 routes — ● 44 nav · ○ 14 linked · ⚠ 0 orphan
...
## API surface (`/api/v1`) — 151 route handlers
