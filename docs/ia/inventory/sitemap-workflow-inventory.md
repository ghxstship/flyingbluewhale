...
- **RBAC visible:** owner, admin, controller, collaborator
  ...
  - _Section:_ **PageContent** → LinkGrid, CardLink\*
...
- **RBAC visible:** owner, admin, controller, collaborator
  - _Section:_ **PageChrome** → Breadcrumbs, ModuleHeader
  - _Section:_ **PageContent** → DataTable, EmptyState
...
- **RBAC visible:** owner, admin, controller, collaborator
  - _Section:_ **PageChrome** → Breadcrumbs, ModuleHeader
  - _Section:_ **PageContent** → FieldDumpDL, BackButton
...
- **RBAC visible:** owner, admin, controller, collaborator
  - _Section:_ **PageChrome** → Breadcrumbs, ModuleHeader
  - _Section:_ **PageContent** → FormShell, Input*, Select*, Button[type=submit]
