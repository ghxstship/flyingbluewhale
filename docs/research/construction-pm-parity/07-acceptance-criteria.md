...
| G-030 | Multi-entity / multi-currency               | post-parity ↗ deferred by design (G-030 in master roadmap; F44 in parity matrix). | Sister-org model + FX rate snapshots at line level. Not in scope for Wave 1–4 parity. |
...
- **Post-parity P2 finishers** — G-030 multi-entity, G-031 GraphQL, G-032 marketplace, G-033 native wrappers. See [03-gap-inventory.md §P2](03-gap-inventory.md).
...
The construction-PM parity program (rounds 35–72) is **delivered**:

- **All 38 gaps** from the inventory at C/S except F44 (post-parity by design).
- **Zero remaining schema gaps.** Zero remaining client-island P-items.
...
The next motion is the **Wave 5 differentiator program**, scoped separately in the master roadmap.
