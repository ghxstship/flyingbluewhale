...
Codebase reference: `flyingbluewhale` (ATLVS Technologies) at commit `71a40e4`.
...
1. **No "solution" / sub-space concept.** SmartSuite Workspace → Solution → Application → Record is a 4-level hierarchy. ATLVS has Org → Project → Resource (effectively 3 levels), and Project is a domain entity, not a generic container. There is no template / blueprint primitive for spinning up a project.
...
- **No "Commenter" or "Assignee-only"** — closest ATLVS analog is `viewer` (read all) or `vendor` (locked to one project). Neither matches Commenter, neither matches "can edit only assigned records".
...
| Feature                                | SmartSuite                                                                    | ATLVS                                                                                                                                                  | File / Table                                                |
| -------------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
...
| Feature                   | SmartSuite                                                 | ATLVS                                                                                       | Source                                                    |
| ------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
