...
test.describe("console modules — self-seeding dependent creates (batch 6)", () => {
  ...
  test("Production · rental (seed equipment → rental)", async ({ page }) => {
    await createInModule(page, "/console/production/equipment/new", { name: `E2E Eq ${stamp()}` });
    await createInModule(page, "/console/production/rentals/new", {
      equipment_id: "auto",
      rate: "100",
  ...
  test("Procurement · submittal (seed vendor → submittal)", async ({ page }) => {
    await createInModule(page, "/console/procurement/vendors/new", { name: `E2E Vendor ${stamp()}` });
    await createInModule(page, "/console/submittals/new", {
  ...
  test.skip("People · MSA (seed crew → MSA)", async ({ page }) => {
    ...
    await createInModule(page, "/console/people/msas/new", { crew_member_id: "auto" });
  });
  ...
  test.skip("Participants · entry (seed delegation → entry)", async ({ page }) => {
    ...
    await createInModule(page, "/console/participants/entries/new", {
      delegation_id: "auto",
  ...
  test.skip("Procurement · prequalification (seed vendor + questionnaire → prequal)", async ({ page }) => {
    const s = stamp();
    await createInModule(page, "/console/procurement/vendors/new", { name: `E2E Vendor ${s}` });
    await createInModule(page, "/console/procurement/prequalification/questionnaires/new", {
      code: `PQ-${s.slice(-5)}`,
      name: `E2E Q ${s}`,
    });
    await createInModule(page, "/console/procurement/prequalification/new", {
      vendor_id: "auto",
  ...
  test.skip("Operations · inspection (seed template → inspection)", async ({ page }) => {
    ...
    await createInModule(page, "/console/inspections/new", {
  ...
  test.skip("Finance · pay-app (seed vendor → PO → pay-app)", async ({ page }) => {
    const s = stamp();
    await createInModule(page, "/console/procurement/vendors/new", { name: `E2E Vendor ${s}` });
    await createInModule(page, "/console/procurement/purchase-orders/new", {
      title: `E2E PO ${s}`,
      vendor_id: "auto",
      amount: "5000",
    });
    await createInModule(page, "/console/finance/pay-apps/new", { purchase_order_id: "auto" });
  });
  ...
  test.skip("Procurement · PO change order (seed vendor → PO → change order)", async ({ page }) => {
    ...
    await createInModule(page, "/console/procurement/po-change-orders/new", {
