...
**Run:** 2026-05-09 · operator: Claude Opus 4.7 · scope: flyingbluewhale (LYTEHAUS Technologies)
...
Per the user's reconciled mapping (turn 3): use LYTEHAUS-implementation names; treat XPMS/USNP as conceptual labels. Full mapping in [docs/XPMS_TO_LYTEHAUS_MAPPING.md](../docs/XPMS_TO_LYTEHAUS_MAPPING.md). Summarised here for the in-scope subsystem list.
...
| `(ghxstship)`      | 15      | **Parent-co marketing surface** — separate brand (locked bermuda-triangle theme), out of LYTEHAUS app scope; included for completeness                                                                                                                                                                                                     | [src/app/(ghxstship)/](<../src/app/(ghxstship)/>)               |
...
- ✅ [docs/XPMS_TO_LYTEHAUS_MAPPING.md](../docs/XPMS_TO_LYTEHAUS_MAPPING.md)
