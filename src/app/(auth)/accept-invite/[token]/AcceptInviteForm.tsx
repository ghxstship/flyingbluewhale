...
export function AcceptInviteForm({ token }: { token: string }) {
  ...
  return (
    <AuthShell
      ...
      subtitle="Accept your invitation to FLYTEHAUS Technologies"
      footer={
    ...
    >
      <p className="text-sm text-[var(--text-secondary)]">
        You&apos;ve been invited to a FLYTEHAUS Technologies workspace. Accept below and we&apos;ll take you straight
        in.
      </p>
      {state?.error && (
