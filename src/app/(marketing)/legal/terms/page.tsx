export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="hed-xl">Terms of Service</h1>
      ...
      <div className="mt-8 space-y-6 text-sm text-[var(--p-text-2)]">
        <section>
          <h2 className="text-base font-semibold text-[var(--p-text-1)]">1. Acceptance of Terms</h2>
          <p className="mt-2">
            By accessing or using the ATLVS Technologies platform you agree to these Terms. If you do not agree, do not
            use the Service.
          </p>
        </section>
        <section>
          <h2 className="text-base font-semibold text-[var(--p-text-1)]">2. Accounts</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--p-text-1)]">3. Subscription & Billing</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--p-text-1)]">4. Data Ownership</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--p-text-1)]">5. Termination</h2>
          <p className="mt-2">
