          ...
          <div className="surface p-5">
            ...
            <dl className="space-y-1 text-sm">
              <div>
                ...
                {t.monthly_listeners != null ? formatNumber(t.monthly_listeners, { maximumFractionDigits: 0 }) : "—"}
              </div>
              <div>
                <span className="text-[var(--text-secondary)]">Followers:</span>{" "}
                {t.follower_count != null ? formatNumber(t.follower_count, { maximumFractionDigits: 0 }) : "—"}
              </div>
              <div>
