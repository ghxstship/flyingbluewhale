...
const INDUSTRIES: Record<string, IndustryConfig> = {
  "live-events": {
    ...
    description:
      "LYTEHAUS Technologies is the production platform for Live Events — club residencies, brand-hosted nights, album release parties, rooftop pop-ups. Ticketing with on-site scan, artist advancing, direct vendor payouts, and per-role Know Before You Go guides — all connected on day one.",
    hero: {
      eyebrow: "Live Events",
      title: "From Pitch to Wrap. One Platform.",
      body: "Replace the stack most venue teams run — Asana for tasks, DocuSign for contracts, QuickBooks for invoices, spreadsheets for advancing. LYTEHAUS Technologies unifies all of it.",
    },
    stats: [
  ...
  "brand-activations": {
    ...
    hero: {
      ...
      body: "Activations live or die by the speed of the hand-off — agency to client, creative to production, production to vendors. LYTEHAUS Technologies shortens every hand-off to zero.",
    },
    stats: [
  ...
  "corporate-events": {
    ...
    description:
      "LYTEHAUS Technologies for Corporate Events — conferences, shareholder meetings, executive summits, internal kickoffs. Client-facing proposals, vendor COI tracking, stakeholder portals, and executive-grade guest experiences.",
    hero: {
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildMetadata({
    title: `${info.name} — ${info.tagline} on LYTEHAUS Technologies`,
