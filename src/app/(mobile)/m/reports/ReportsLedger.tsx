...
import type { OpsReport } from "@/lib/mobile/ops-seed";

/**
 * COMPVSS · Reports — the incident & daily-log ledger (kit 33 v3.0, Operations).
 * Rows are the real org-scoped `field_reports` (the page reads them); File A
 * Report routes to the real incident intake.
 */
...
export function ReportsLedger({ items }: { items: OpsReport[] }) {
  return (
