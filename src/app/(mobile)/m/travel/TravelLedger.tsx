...
import type { OpsTravel } from "@/lib/mobile/ops-seed";

/**
 * COMPVSS · Travel & Lodging — itineraries, hotels, ground & per-diem ledger
 * (kit 33 v3.0, Operations). Rows are the real org-scoped `field_travel`.
 */
...
export function TravelLedger({ items }: { items: OpsTravel[] }) {
  return (
