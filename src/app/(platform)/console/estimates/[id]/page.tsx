  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.estimates.detail.breadcrumb.creative", undefined, "Creative"), href: "/console/estimates" },
          { label: t("console.estimates.detail.breadcrumb.estimates", undefined, "Estimates"), href: "/console/estimates" },
          { label: estimate.name },
        ]}
        action={
          <div className="flex items-center gap-2">
            <Button href={`/console/estimates/${id}/edit`} size="sm" variant="secondary">
            ...
            <DeleteForm
              ...
              undo={{ table: "estimates", id, redirectTo: "/console/estimates" }}
            />
          </div>
        }
      />
