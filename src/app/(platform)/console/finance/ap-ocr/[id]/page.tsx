    ...
    <>
        ...
        action={
          <div className="flex items-center gap-2">
            ...
            {e.promoted_invoice_id && (
              <Button href={`/console/finance/invoices/${e.promoted_invoice_id}`} size="sm" variant="secondary">
                {t("console.finance.apOcr.detail.openInvoice", undefined, "Open Invoice")}
              </Button>
            )}
            <Button href="/console/finance/ap-ocr" size="sm" variant="ghost">
      ...
      <div className="page-content space-y-6">
        <div className="surface flex flex-wrap items-center gap-3 p-3 text-xs">
          ...
          {e.matched_vendor_id && (
            <a className="text-[var(--p-accent)] underline" href={`/console/procurement/vendors/${e.matched_vendor_id}`}>
          ...
          {e.matched_purchase_order_id && (
            <a
              ...
              href={`/console/procurement/purchase-orders/${e.matched_purchase_order_id}`}
            >
