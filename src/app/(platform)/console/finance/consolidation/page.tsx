        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          {bucketList.length === 0 ? (
            <EmptyState
              ...
              description="Create a legal entity to enable consolidated reporting."
              action={
                <Link href="/console/finance/entities/new" className="text-xs underline text-[var(--color-info)]">
