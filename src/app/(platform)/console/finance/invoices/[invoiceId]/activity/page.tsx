...
export default async function Page({ params }: { params: Promise<{ invoiceId: string }> }) {
  ...
  return (
    <>
      <ModuleHeader eyebrow="Invoice" title="Activity" subtitle="Audit trail for this invoice." />
      <div className="page-content">
        <DataTable<Row>
          rows={rows}
          emptyLabel="No Activity Yet"
          emptyDescription="Audit log entries appear here as the invoice moves between statuses or is edited."
          columns={[
            {
              key: "at",
              header: "When",
