...
export default async function LeadLayout({
  ...
  const tabs = [
    { label: t("console.leads.detail.tabs.overview", undefined, "Overview"), href: `/console/leads/${leadId}` },
    {
      label: t("console.leads.detail.tabs.activity", undefined, "Activity"),
      href: `/console/leads/${leadId}/activity`,
    },
    {
      label: t("console.leads.detail.tabs.proposals", undefined, "Proposals"),
      href: `/console/leads/${leadId}/proposals`,
    },
  ];
