      ...
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href="/console/legend/engine/rules" variant="secondary">
              Rules
            </Button>
            <Button href="/console/legend/engine/runs">Runs</Button>
          </div>
        }
      />
      <div className="page-content space-y-6">
        ...
        <section className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Button href="/console/legend/engine/runs" variant="ghost" size="sm">
              View all
            </Button>
          </div>
          {recentRuns.length === 0 ? (
            <EmptyState
              ...
              action={<Button href="/console/legend/engine/runs">Go to runs</Button>}
            />
          ) : (
            <div className="surface divide-y divide-[var(--p-border)]">
              {recentRuns.map((r) => (
                <a
                  key={r.id}
                  href={`/console/legend/engine/runs/${r.id}`}
