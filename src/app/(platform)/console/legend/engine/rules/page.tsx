  ...
  return (
    <>
      <ModuleHeader
        ...
        action={<Button href="/console/legend/engine/rules/new">+ New Rule</Button>}
      />
      <div className="page-content">
        <DataTable<ComplianceRuleRow>
          rows={rows}
          rowHref={(r) => `/console/legend/engine/rules/${r.id}`}
          emptyLabel="No compliance rules yet"
          emptyDescription="Author your first rule to start running compliance checks."
          emptyAction={<Button href="/console/legend/engine/rules/new">+ New Rule</Button>}
          columns={[
            {
              key: "code",
              header: "Code",
