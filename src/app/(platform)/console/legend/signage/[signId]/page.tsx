  ...
  return (
    <>
      <ModuleHeader
        ...
        subtitle={sign.code}
        breadcrumbs={[
          { label: "LEG3ND", href: "/console/legend/signage" },
          { label: "Signage Library", href: "/console/legend/signage" },
          { label: sign.name },
        ]}
        action={
          <div className="flex items-center gap-2">
            ...
            <DeleteForm
              ...
              undo={{ table: "signage_signs", id: signId, redirectTo: "/console/legend/signage" }}
            />
          </div>
        }
      />
