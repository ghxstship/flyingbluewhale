...
export default async function Page() {
  if (!hasSupabase) return (
    <><ModuleHeader eyebrow="Console" title="Rate Card Items" /><div className="page-content"><div className="surface p-6 text-sm">Configure Supabase.</div></div></>
  );
  ...
  return (
    <>
      <ModuleHeader
        ...
        action={<Button href="/console/logistics/ratecard/new" size="sm">+ New item</Button>}
      />
      <div className="page-content">
        <DataTable
          ...
          emptyAction={<Button href="/console/logistics/ratecard/new" size="sm">+ New item</Button>}
          columns={[
