    ...
    <>
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href="/console/marketplace/discounts/promoters" size="sm" variant="secondary">
              Promoters
            </Button>
            <Button href="/console/marketplace/discounts/new">+ New Code</Button>
          </div>
        }
      />
      <div className="page-content">
        <DataTable<DiscountRow>
          rows={rows}
          rowHref={(r) => `/console/marketplace/discounts/${r.id}`}
          columns={[
            {
              key: "code",
              header: "Code",
