    ...
    <>
      ...
      <div className="page-content space-y-5">
        <section className="surface p-5">
          <h2 className="mb-2 text-sm font-semibold tracking-wide uppercase">Body</h2>
          <div className="text-sm whitespace-pre-wrap">{body ?? "—"}</div>
        </section>
        {r.file_url && (
          <section className="surface p-5">
            <h2 className="mb-2 text-sm font-semibold tracking-wide uppercase">Attached File</h2>
