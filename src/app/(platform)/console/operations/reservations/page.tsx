    ...
    <>
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href="/console/operations/reservations/tables/new" size="sm" variant="secondary">
              {t("console.reservations.newTable", undefined, "+ New Table")}
            </Button>
            <Button href="/console/operations/reservations/new" size="sm">
      ...
      <div className="page-content space-y-5">
        ...
        <DataTable<ReservationRow>
          rows={rows}
          rowHref={(r) => `/console/operations/reservations/${r.id}`}
