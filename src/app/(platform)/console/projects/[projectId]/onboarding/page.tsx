...
export default async function ProjectOnboardingPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return (
    <>
      <ModuleHeader
        eyebrow="Onboarding"
        title={(project as unknown as Project).name + " — Onboarding"}
        subtitle={subtitle}
      />
            ...
            },
            {
              ...
              render: (r) => (
                <span className="font-mono text-xs">
                  {r.done}/{r.total} {r.total > 0 && r.done === r.total ? <Badge variant="success">Done</Badge> : null}
                </span>
              ),
