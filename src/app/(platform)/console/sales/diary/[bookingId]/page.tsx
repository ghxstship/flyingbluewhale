  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.diary.detail.breadcrumb.sales", undefined, "Sales"), href: "/console/sales/diary" },
          { label: t("console.diary.detail.breadcrumb.diary", undefined, "Function Diary"), href: "/console/sales/diary" },
          { label: booking.title },
        ]}
        action={
          <div className="flex items-center gap-2">
            <Button href={`/console/sales/diary/${bookingId}/edit`} size="sm" variant="secondary">
            ...
            <DeleteForm
              ...
              undo={{ table: "function_bookings", id: bookingId, redirectTo: "/console/sales/diary" }}
            />
          </div>
        }
      />
