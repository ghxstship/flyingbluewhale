...
export default async function DiaryPage({
  ...
  const prevHref = `/console/sales/diary?start=${shiftDay(windowStart, -WINDOW_DAYS)}`;
  const nextHref = `/console/sales/diary?start=${shiftDay(windowStart, WINDOW_DAYS)}`;
  const todayHref = `/console/sales/diary`;
      ...
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href="/console/sales/diary/spaces" size="sm" variant="secondary">
              {t("console.diary.manageSpaces", undefined, "Spaces")}
            </Button>
            <Button href="/console/sales/diary/new" size="sm">
      ...
      <div className="page-content space-y-4">
        ...
        {activeSpaces.length === 0 ? (
          <EmptyState
            ...
            action={
              <Button href="/console/sales/diary/spaces/new">
                  ...
                  return (
                    <tr key={space.id}>
                      <td className="align-top">
                        <Link href={`/console/sales/diary/spaces`} className="text-sm font-medium">
                          {space.name}
                        </Link>
                        {space.venue && (
