  ...
  return (
    <>
      ...
      <div className="page-content space-y-6">
        <section>
          ...
          <div className="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <Link className="surface hover-lift p-4" href="/console/leads">
              ...
              <div className="mt-1 text-xs text-[var(--text-muted)]">Pipeline kanban + saved views</div>
            </Link>
        ...
        <section>
          <h2 className="text-xs font-semibold tracking-wider text-[var(--text-muted)] uppercase">Hospitality</h2>
        ...
        <section>
          <h2 className="text-xs font-semibold tracking-wider text-[var(--text-muted)] uppercase">Marketplace</h2>
          <div className="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <Link className="surface hover-lift p-4" href="/console/marketplace">
              <div className="text-sm font-medium">Marketplace</div>
              <div className="mt-1 text-xs text-[var(--text-muted)]">Postings, calls, talent, offers, reviews</div>
            </Link>
            <Link className="surface hover-lift p-4" href="/console/bookings">
              <div className="text-sm font-medium">Bookings</div>
              <div className="mt-1 text-xs text-[var(--text-muted)]">Deals, holds, calendar, settlements</div>
            </Link>
        ...
        <section>
          <h2 className="text-xs font-semibold tracking-wider text-[var(--text-muted)] uppercase">Revenue</h2>
          <div className="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Link className="surface hover-lift p-4" href="/console/insights">
              ...
              <div className="mt-1 text-xs text-[var(--text-muted)]">Cross-cutting BI rollup</div>
            </Link>
          </div>
        </section>
      </div>
