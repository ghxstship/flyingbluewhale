  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.specs.edit.breadcrumbs.specs", undefined, "Specs"), href: "/console/specs" },
          { label: section.section_number, href: `/console/specs/${section.id}` },
      ...
      <div className="page-content max-w-2xl">
        <FormShell
          ...
          cancelHref={`/console/specs/${section.id}`}
