  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.takeoffs.detail.breadcrumb.creative", undefined, "Creative"), href: "/console/takeoffs" },
          { label: t("console.takeoffs.detail.breadcrumb.takeoffs", undefined, "Takeoffs"), href: "/console/takeoffs" },
          { label: takeoff.name },
        ]}
        action={
          <div className="flex items-center gap-2">
            <Button href={`/console/takeoffs/${id}/edit`} size="sm" variant="secondary">
            ...
            <DeleteForm
              ...
              undo={{ table: "takeoffs", id, redirectTo: "/console/takeoffs" }}
            />
          </div>
        }
      />
