  ...
  return (
    <>
      ...
      <div className="page-content">
        ...
        <label className="flex flex-col gap-1 text-sm"><span>Cluster</span><input type="text" name="cluster" className="surface-inset p-3 rounded" /></label>
        <label className="flex flex-col gap-1 text-sm"><span>Capacity</span><input type="number" name="capacity" className="surface-inset p-3 rounded" /></label>
