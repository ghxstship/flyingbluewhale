...
export async function updateContractor(id: string, _: State, fd: FormData): Promise<State> {
  ...
  revalidatePath(`/console/workforce/contractors/${id}`);
  revalidatePath("/console/workforce/contractors");
  redirect(`/console/workforce/contractors/${id}`);
}
...
export async function deleteContractor(id: string): Promise<void> {
  ...
  revalidatePath("/console/workforce/contractors");
  redirect("/console/workforce/contractors");
}
