...
import { deleteContractor } from "./edit/actions";
      ...
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href="/console/workforce/contractors" variant="ghost" size="sm">
              Back
            </Button>
            <Button href={`/console/workforce/contractors/${p.contractorId}/edit`} size="sm">
              Edit
            </Button>
            <DeleteForm
