  ...
  return (
    <>
      <ModuleHeader
        ...
        action={
          <Button href="/studio/accreditation/categories" variant="secondary" size="sm">
          ...
          <EmptyState
            ...
            action={
              <div className="flex items-center gap-2">
                <Link href="/studio/accreditation/categories/new" className={buttonVariants({ size: "sm" })}>
                  {t("console.accreditation.policy.newCategory", undefined, "+ New Category")}
                </Link>
                <Link href="/studio/venues" className={buttonVariants({ variant: "ghost", size: "sm" })}>
