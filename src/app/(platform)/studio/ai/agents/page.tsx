  ...
  return (
    <>
      <ModuleHeader
        ...
        action={
          <Button href="/studio/ai/agents/new" size="sm">
      ...
      <div className="page-content space-y-5">
        ...
        {rows.length === 0 ? (
          <EmptyState
            ...
            action={
              <Link href="/studio/ai/agents/new" className={buttonVariants({ size: "sm" })}>
                {t("console.ai.agents.newAction", undefined, "+ New Agent")}
              </Link>
            }
          />
          ...
          <ul className="space-y-2">
            {rows.map((r) => (
              <li key={r.id}>
                <Link href={`/studio/ai/agents/${r.id}`} className="surface flex items-center justify-between p-4">
