    ...
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          ...
          { label: automation.name, href: `/studio/ai/automations/${automationId}` },
          ...
          {STATUS_FILTERS.map((f) => {
            ...
            const href =
              f.key === "all"
                ...
                : `/studio/ai/automations/${automationId}/runs?status=${f.key}`;
            return (
              <Link
                key={f.key}
                href={href}
                  ...
                  return (
                    <tr key={r.id} className="border-t border-[var(--p-border)]">
                      <td className="px-3 py-2 font-mono text-xs">
                        <Link href={`/studio/ai/automations/${automationId}/runs/${r.id}`} className="hover:underline">
                          {fmt(r.started_at)}
                        </Link>
                      </td>
