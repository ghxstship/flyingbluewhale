    ...
    <>
      ...
      <div className="page-content max-w-xl">
        <FormShell
          ...
          cancelHref="/studio/ai/automations"
        ...
        >
          ...
          <div>
            <label htmlFor="trigger_kind" className="text-xs font-medium text-[var(--p-text-2)]">
              {t("console.ai.automations.new.trigger", undefined, "Trigger")}
            </label>
            <select id="trigger_kind" name="trigger_kind" defaultValue="manual" className="ps-input mt-1.5 w-full">
