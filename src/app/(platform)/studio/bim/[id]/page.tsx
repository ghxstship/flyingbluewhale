    ...
    <>
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            ...
            <Button href={`/studio/bim/${m.id}/edit`} size="sm" variant="secondary">
              {t("console.bim.detail.edit", undefined, "Edit")}
            </Button>
            <Button href="/studio/bim" size="sm" variant="ghost">
      ...
      <div className="page-content space-y-6">
        <div className="surface flex flex-wrap items-center gap-3 p-3 text-xs">
          ...
          {m.failed_reason && <span className="text-[var(--p-danger)]">{m.failed_reason}</span>}
