  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.drawings.edit.breadcrumbs.drawings", undefined, "Drawings"), href: "/studio/drawings" },
          { label: set.name, href: `/studio/drawings/${set.id}` },
      ...
      <div className="page-content max-w-2xl">
        <FormShell
          ...
          cancelHref={`/studio/drawings/${set.id}`}
