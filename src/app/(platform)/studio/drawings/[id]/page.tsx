  ...
  return (
    <>
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href={`/studio/drawings/${sheetSet.id}/edit`} size="sm" variant="secondary">
              {t("console.drawings.detail.edit", undefined, "Edit")}
            </Button>
            <Button href="/studio/drawings" size="sm" variant="ghost">
      ...
      <div className="page-content space-y-6">
        ...
        {/* ── Sheet preview (kit v7 FileViewer) ──────────────────────────── */}
        <section className="space-y-2">
          <h2 className="text-sm font-semibold">{t("console.drawings.detail.preview", undefined, "Sheet preview")}</h2>
          <FileViewer
            src=""
            kind="doc"
            name={
              memberRows[0]?.site_plan
                ? `${memberRows[0].site_plan.code} — ${memberRows[0].site_plan.title}`
                : sheetSet.name
            }
            pages={memberRows.length || undefined}
            page={memberRows.length ? 1 : undefined}
          />
        </section>
