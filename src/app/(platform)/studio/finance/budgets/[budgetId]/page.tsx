    ...
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          ...
          { label: t("console.finance.budgets.breadcrumb", undefined, "Budgets"), href: "/studio/finance/budgets" },
          { label: budget.name },
        ]}
        action={
          <div className="flex items-center gap-2">
            ...
            <Button href={`/studio/finance/budgets/${budget.id}/edit`} size="sm" variant="secondary">
