      ...
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href="/studio/finance/budgets/import" variant="secondary">
              {t("console.finance.budgets.importAction", undefined, "Import")}
            </Button>
            <Button href="/studio/finance/budgets/summary" variant="secondary">
              {t("console.finance.budgets.summaryAction", undefined, "Summary")}
            </Button>
            <Button href="/studio/finance/budgets/new">
