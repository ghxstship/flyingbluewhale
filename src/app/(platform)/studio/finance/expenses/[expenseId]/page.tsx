  ...
  return (
    <DetailShell
      ...
      breadcrumbs={[
        ...
        { label: t("console.finance.expenses.breadcrumb", undefined, "Expenses"), href: "/studio/finance/expenses" },
      ...
      action={
        row ? (
          <div className="flex items-center gap-2">
            <Button href={`/studio/finance/expenses/${expenseId}/edit`} size="sm" variant="secondary">
