  ...
  return (
    <>
      <ModuleHeader
        ...
        action={
          <Button href="/studio/finance/expenses/new">
      ...
      <div className="page-content space-y-3">
        <DataTable<Expense>
          ...
          emptyAction={
            <Button href="/studio/finance/expenses/new" size="sm">
              {t("console.finance.expenses.logExpense", undefined, "+ Log expense")}
            </Button>
          }
          columns={[
        ...
        {(offset > 0 || page.nextCursor) && (
          <nav className="flex items-center justify-between text-xs">
              ...
              <Link
                href={
                  offset - PAGE_SIZE <= 0
                    ...
                    : `/studio/finance/expenses?cursor=${offset - PAGE_SIZE}`
                }
            ...
            {page.nextCursor ? (
              <Link
                href={`/studio/finance/expenses?cursor=${page.nextCursor}`}
                className="text-[var(--brand-color)] hover:underline"
              >
