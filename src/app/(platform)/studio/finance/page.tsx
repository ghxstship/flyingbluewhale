...
export default async function FinanceHub() {
  ...
  const tiles = [
    { href: "/studio/finance/invoices", label: t("console.finance.tiles.invoices", undefined, "Invoices") },
    { href: "/studio/finance/expenses", label: t("console.finance.tiles.expenses", undefined, "Expenses") },
    { href: "/studio/finance/budgets", label: t("console.finance.tiles.budgets", undefined, "Budgets") },
    { href: "/studio/finance/time", label: t("console.finance.tiles.time", undefined, "Time") },
    { href: "/studio/finance/mileage", label: t("console.finance.tiles.mileage", undefined, "Mileage") },
    { href: "/studio/finance/payouts", label: t("console.finance.tiles.payouts", undefined, "Payouts") },
    { href: "/studio/finance/entities", label: t("console.finance.tiles.entities", undefined, "Entities") },
    {
      href: "/studio/finance/consolidation",
      label: t("console.finance.tiles.consolidation", undefined, "Consolidation"),
    },
    { href: "/studio/finance/reports", label: t("console.finance.tiles.reports", undefined, "Reports") },
  ];
