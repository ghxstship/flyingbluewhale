...
export default async function Page() {
  ...
  const { data } = await supabase
    ...
    .select(
      "id, application_number, period_start, period_end, status:application_state, total_completed_cents, total_due_cents, retention_pct, vendor:vendor_id(name), purchase_order:purchase_order_id(number, title)",
    )
  ...
  return (
    <>
      <ModuleHeader
        ...
        action={
          <Button href="/studio/finance/pay-apps/new" size="sm">
