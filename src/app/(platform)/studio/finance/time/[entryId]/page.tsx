...
export default async function Page({ params }: { params: Promise<{ entryId: string }> }) {
  ...
  return (
    <DetailShell
      ...
      breadcrumbs={[
        { label: t("console.finance.time.entry.breadcrumbs.finance", undefined, "Finance"), href: "/studio/finance" },
        { label: t("console.finance.time.entry.breadcrumbs.time", undefined, "Time"), href: "/studio/finance/time" },
      ...
      action={
        row ? (
          <div className="flex items-center gap-2">
            <Button href={`/studio/finance/time/${entryId}/edit`} size="sm" variant="secondary">
