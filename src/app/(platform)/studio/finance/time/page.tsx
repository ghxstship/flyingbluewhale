  ...
  return (
    <>
      <ModuleHeader
        ...
        action={
          <Button href="/studio/finance/time/new">
      ...
      <div className="page-content space-y-3">
        <DataTable<TimeEntry>
          ...
          emptyAction={
            <Button href="/studio/finance/time/new" size="sm">
              {t("console.finance.time.newEntry", undefined, "+ New Entry")}
            </Button>
          }
          columns={[
        ...
        {(offset > 0 || page.nextCursor) && (
          <nav className="flex items-center justify-between text-xs">
            {offset > 0 ? (
              <Link
                href={
                  offset - PAGE_SIZE <= 0
                    ? "/studio/finance/time"
                    : `/studio/finance/time?cursor=${offset - PAGE_SIZE}`
                }
            ...
            {page.nextCursor ? (
              <Link
                href={`/studio/finance/time?cursor=${page.nextCursor}`}
                className="text-[var(--brand-color)] hover:underline"
              >
