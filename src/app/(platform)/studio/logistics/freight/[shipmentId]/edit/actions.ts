...
export async function updateShipment(id: string, _: State, fd: FormData): Promise<State> {
  ...
  revalidatePath(`/studio/logistics/freight/${id}`);
  revalidatePath("/studio/logistics/freight");
  redirect(`/studio/logistics/freight/${id}`);
}
...
export async function deleteShipment(id: string): Promise<void> {
  ...
  revalidatePath("/studio/logistics/freight");
  redirect("/studio/logistics/freight");
}
