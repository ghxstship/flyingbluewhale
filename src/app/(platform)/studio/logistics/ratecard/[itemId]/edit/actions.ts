...
export async function updateRateCardItem(id: string, _: State, fd: FormData): Promise<State> {
  ...
  revalidatePath(`/studio/logistics/ratecard/${id}`);
  revalidatePath("/studio/logistics/ratecard");
  redirect(`/studio/logistics/ratecard/${id}`);
}
...
export async function deleteRateCardItem(id: string): Promise<void> {
  ...
  revalidatePath("/studio/logistics/ratecard");
  redirect("/studio/logistics/ratecard");
}
