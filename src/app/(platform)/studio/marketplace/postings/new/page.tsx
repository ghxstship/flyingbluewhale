        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select id="posting_type" name="posting_type" className="ps-input mt-1.5 w-full" defaultValue="single">
                <option value="single">
            ...
            <div>
              ...
              <select id="employment_type" name="employment_type" className="ps-input mt-1.5 w-full" defaultValue="1099">
                <option value="1099">
