    ...
    <>
      ...
      <div className="page-content">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          <Link className="surface hover-lift p-4" href="/studio/operations/dispatch">
          ...
          <Link className="surface hover-lift p-4" href="/studio/operations/maintenance">
            <div className="text-sm font-medium">
          ...
          <Link className="surface hover-lift p-4" href="/studio/operations/incidents">
            <div className="text-sm font-medium">{t("console.operations.incidents.title", undefined, "Incidents")}</div>
          </Link>
          <Link className="surface hover-lift p-4" href="/studio/services/requests">
            <div className="text-sm font-medium">
