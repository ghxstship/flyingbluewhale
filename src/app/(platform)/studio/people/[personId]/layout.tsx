...
export default async function PersonLayout({
  ...
  const tabs = [
    { label: t("console.people.person.tabs.profile", undefined, "Profile"), href: `/studio/people/${personId}` },
    {
      label: t("console.people.person.tabs.assignments", undefined, "Assignments"),
      href: `/studio/people/${personId}/assignments`,
    },
    {
      label: t("console.people.person.tabs.credentials", undefined, "Credentials"),
      href: `/studio/people/${personId}/credentials`,
    },
    { label: t("console.people.person.tabs.time", undefined, "Time"), href: `/studio/people/${personId}/time` },
    {
      label: t("console.people.person.tabs.documents", undefined, "Documents"),
      href: `/studio/people/${personId}/documents`,
    },
  ];
