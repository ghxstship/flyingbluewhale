...
export default async function VendorLayout({
  ...
  const tabs = [
    ...
    },
    {
      ...
      href: `/studio/procurement/vendors/${vendorId}/pos`,
    },
    {
      label: t("console.procurement.vendors.tabs.submittals", undefined, "Submittals"),
      href: `/studio/procurement/vendors/${vendorId}/submittals`,
    },
    {
    ...
    },
    {
      ...
      href: `/studio/procurement/vendors/${vendorId}/scorecard`,
    },
    {
      label: t("console.procurement.vendors.tabs.onboarding", undefined, "Onboarding"),
      href: `/studio/procurement/vendors/${vendorId}/onboarding`,
    },
  ];
