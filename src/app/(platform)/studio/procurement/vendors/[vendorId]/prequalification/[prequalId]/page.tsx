  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.procurement.title", undefined, "Procurement"), href: "/studio/procurement" },
          { label: t("console.procurement.vendors.title", undefined, "Vendors"), href: "/studio/procurement/vendors" },
          {
            label: prequal.vendor?.name ?? t("console.procurement.vendors.detail.fallbackLabel", undefined, "Vendor"),
            href: `/studio/procurement/vendors/${vendorId}`,
          },
          {
            label: t("console.procurement.vendors.prequalification.title", undefined, "Prequalification"),
            href: `/studio/procurement/vendors/${vendorId}/prequalification`,
          },
          {
            label:
              prequal.questionnaire?.name ??
        ...
        action={
          <Button href={`/studio/procurement/vendors/${vendorId}/prequalification`} variant="ghost" size="sm">
