      ...
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.production.equipment.eyebrow", undefined, "Production") },
          {
            ...
            href: "/studio/production/equipment",
          },
          { label: row.name },
        ]}
        action={
          <div className="flex items-center gap-1">
            ...
            <a href={`/studio/production/equipment/${row.id}/qr`} className="ps-btn ps-btn--ghost ps-btn--sm">
              {t("console.production.equipment.detail.qr", undefined, "QR")}
            </a>
            <a href={`/studio/production/equipment/${row.id}/edit`} className="ps-btn ps-btn--ghost ps-btn--sm">
        ...
        <section className="surface p-4 text-xs">
          <div className="flex items-center justify-between">
            ...
            <DeleteForm
              ...
              undo={{ table: "equipment", id: row.id, redirectTo: "/studio/production/equipment" }}
            />
          </div>
        </section>
      </div>
