...
export async function updateCeremony(id: string, _: State, fd: FormData): Promise<State> {
  ...
  revalidatePath(`/studio/programs/ceremonies/${id}`);
  revalidatePath("/studio/programs/ceremonies");
  redirect(`/studio/programs/ceremonies/${id}`);
}
...
export async function deleteCeremony(id: string): Promise<void> {
  ...
  revalidatePath("/studio/programs/ceremonies");
  redirect("/studio/programs/ceremonies");
}
