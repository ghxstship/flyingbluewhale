      ...
      <div className="page-content space-y-6">
        ...
        {budgetTotal > 0 && (
          <section className="surface p-5">
            <header className="flex items-center justify-between">
              ...
              <Link
                href={`/studio/projects/${projectId}/budget`}
        ...
        <section>
          <header className="mb-2 flex items-center justify-between">
            ...
            <Link href="/studio/finance/invoices" className="text-xs text-[var(--p-accent)] hover:underline">
        ...
        <section>
          <header className="mb-2 flex items-center justify-between">
            ...
            <Link href="/studio/finance/expenses" className="text-xs text-[var(--p-accent)] hover:underline">
