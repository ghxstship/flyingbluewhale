      ...
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-3">
            ...
            />
            <Button href={`/studio/events/new?project_id=${projectId}`} size="sm">
          ...
          <EmptyState
            ...
            action={
              <Link
                ...
                href={`/studio/events/new?project_id=${projectId}`}
              >
      ...
      {events.length > 0 && (
        <section>
          ...
          <ul className="space-y-2">
            {events.map((e) => (
              <li key={e.id}>
                <Link href={`/studio/events/${e.id}`} className="surface hover-lift block p-4">
      ...
      {tasks.length > 0 && (
        <section>
          ...
          <ul className="space-y-2">
            {tasks.map((task) => (
              <li key={task.id}>
                <Link href={`/studio/tasks/${task.id}`} className="surface hover-lift block p-3">
