  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.projects.tasks.breadcrumbProjects", undefined, "Projects"), href: "/studio/projects" },
          {
      ...
      <div className="page-content max-w-5xl">
        {!tasks || tasks.length === 0 ? (
          <EmptyState
            ...
            action={
              <Link className="text-sm font-medium text-[var(--p-accent)]" href="/studio/tasks/new">
          ...
          <table className="ps-table w-full text-sm">
            ...
            <tbody>
              {tasks.map((task) => (
                <tr key={task.id}>
                  <td>
                    <Link href={`/studio/tasks/${task.id}`} className="hover:underline">
                      {task.title}
                    </Link>
                  </td>
                  <td>
