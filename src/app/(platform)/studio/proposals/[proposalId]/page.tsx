  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.proposals.detail.breadcrumb.revenue", undefined, "Revenue"), href: "/studio/proposals" },
          {
        ...
        action={
          <div className="flex items-center gap-2">
            <Link
              href={`/studio/proposals/${proposal.id}/edit`}
              className={buttonVariants({ variant: "ghost", size: "sm" })}
            >
              {t("console.proposals.detail.editDocument", undefined, "Edit Document")}
            </Link>
            <Link
              href={`/studio/documents/proposal?recordId=${proposal.id}`}
              className={buttonVariants({ variant: "ghost", size: "sm" })}
            >
            ...
            {project && (
              <Link href={`/studio/projects/${project.id}`} className="ps-btn ps-btn--sm">
