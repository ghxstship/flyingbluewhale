  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.punch.breadcrumb", undefined, "Punch"), href: "/studio/punch" },
          { label: t("console.punch.lists.breadcrumb", undefined, "Lists") },
        ]}
        action={
          <Button href="/studio/punch" size="sm" variant="ghost">
          ...
          columns={[
            {
              ...
              render: (r) => (
                <Link href={`/studio/punch?list=${r.id}`} className="font-semibold hover:underline">
                  {r.name}
                </Link>
              ),
              accessor: (r) => r.name,
