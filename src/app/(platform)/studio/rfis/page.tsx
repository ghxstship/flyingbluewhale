...
export default async function Page() {
  ...
  const { data } = await supabase
    .from("rfis")
    .select(
      "id, code, subject, category, status:rfi_state, priority, due_at, closed_at, asked_at, project:project_id(name), ball_in_court:ball_in_court_id(name, email)",
    )
  ...
  return (
    <>
      <ModuleHeader
        ...
        action={
          <Button href="/studio/rfis/new" size="sm">
