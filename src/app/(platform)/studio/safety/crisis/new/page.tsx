    ...
    <>
      ...
      <div className="page-content max-w-xl">
        <FormShell
          ...
          cancelHref="/studio/safety/crisis"
        ...
        >
          ...
          <div>
            ...
            <textarea id="body" name="body" rows={4} required maxLength={4000} className="ps-input mt-1.5 w-full" />
          </div>
          <div>
            ...
            <select id="severity" name="severity" defaultValue="info" className="ps-input mt-1.5 w-full">
