    ...
    <>
      ...
      <div className="page-content max-w-xl">
        <FormShell
          ...
          cancelHref="/studio/safety/medical/encounters"
        ...
        >
          <div>
            ...
            <select id="triage" name="triage" defaultValue="green" className="ps-input mt-1.5 w-full">
              <option value="green">
          ...
          <div>
            ...
            <textarea id="chief_complaint" name="chief_complaint" rows={3} maxLength={500} className="ps-input mt-1.5 w-full" />
          </div>
          <Input
