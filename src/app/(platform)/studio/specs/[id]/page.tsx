      ...
      <ModuleHeader
        ...
        action={
          <div className="flex items-center gap-2">
            <Button href={`/studio/specs/${section.id}/edit`} size="sm" variant="secondary">
              {t("console.specs.detail.edit", undefined, "Edit")}
            </Button>
            <Button href="/studio/specs" size="sm" variant="ghost">
            ...
            <ul className="space-y-1">
              {rfis.map((r) => (
                <li key={r.id} className="text-xs">
                  <a href={`/studio/rfis/${r.id}`} className="font-mono">
                    {r.code}
                  </a>{" "}
            ...
            <ul className="space-y-1">
              {submittals.map((s) => (
                <li key={s.id} className="text-xs">
                  <a href={`/studio/submittals/${s.id}`} className="font-mono">
                    {s.code}
                  </a>{" "}
