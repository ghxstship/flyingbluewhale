  ...
  return (
    <>
      <ModuleHeader
        ...
        breadcrumbs={[
          { label: t("console.workforce.recognition.new.crumbWorkforce", undefined, "Workforce"), href: "/studio" },
          {
            label: t("console.workforce.recognition.new.crumbRecognition", undefined, "Recognition"),
            href: "/studio/workforce/recognition",
          },
      ...
      <div className="page-content max-w-xl">
        <form
          action={async (fd: FormData) => {
            ...
            redirect("/studio/workforce/recognition");
          }}
        ...
        >
          ...
          <div className="flex justify-end gap-2">
            <Button href="/studio/workforce/recognition" variant="ghost">
