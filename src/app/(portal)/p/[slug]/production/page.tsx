...
export default async function ProductionPortalPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const sections = [
    ...
    { href: `/${slug}/production/receiving`, label: 'Receiving', description: 'Inbound deliveries, PO reconciliation, variance tracking' },
    { href: `/${slug}/production/schedules`, label: 'Schedules', description: 'Pickups, deliveries, transfers, dock assignments' },
    ...
    { href: `/${slug}/production/credentials`, label: 'Credentials', description: 'Badge issuance, access levels, credential tracking' },
    { href: `/${slug}/production/lost-found`, label: 'Lost & Found', description: 'Report, catalog, and return lost or found items' },
  ];
    ...
    <>
      <div className="border-b border-border bg-bg/50 backdrop-blur-md px-8 py-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-[0.6875rem] tracking-widest uppercase text-cyan mb-3 font-heading">Production Portal</div>
