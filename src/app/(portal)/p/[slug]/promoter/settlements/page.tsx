            ...
            {rows.length === 0 ? (
              ...
              rows.map((s) => (
                <tr key={s.id}>
                  ...
                  <td className="font-mono text-xs">{fmt.money(s.gross_box_office_cents, s.currency)}</td>
                  <td className="font-mono text-xs">{fmt.number(s.paid_attendance)}</td>
                  <td className="font-mono text-xs">{fmt.number(s.comp_count)}</td>
                  <td className="font-mono text-xs">{fmt.money(s.artist_payout_cents, s.currency)}</td>
                  <td className="font-mono text-xs">{fmt.money(s.balance_due_cents, s.currency)}</td>
                  <td>
