...
export default async function SponsorPortalPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const sections = [
    { href: `/${slug}/sponsor/submissions`, label: 'Sponsor Deliverables', description: 'Submit assets, approvals, and compliance documents.' },
    ...
    <>
      <div className="border-b border-border bg-bg/50 backdrop-blur-md px-8 py-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-[0.6875rem] tracking-widest uppercase text-cyan mb-3 font-heading">Sponsor Portal</div>
