...
export const metadata: Metadata = {
  title: "API Reference",
  description:
    "REST + OpenAPI 3.1 documentation for the LYTEHAUS public API. Auth via session cookie or Bearer PAT; rate limits scale with your plan tier.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-6 py-12">
      <header className="mb-12">
        ...
        <h1 className="mt-2 text-4xl font-semibold">LYTEHAUS API Reference</h1>
