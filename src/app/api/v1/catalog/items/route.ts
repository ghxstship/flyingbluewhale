...
// GET /api/v1/catalog/items - List catalog items (role-filtered by RLS)
  ...
  let query = supabase
    ...
    .select(`
      *,
      ...
      catalog_item_interchange!catalog_item_interchange_item_a_id_fkey (id, item_b_id, compatibility_score, relationship_type),
...
export async function POST(request: NextRequest) {
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      visibility_tags: body.visibility_tags || ['production'],
