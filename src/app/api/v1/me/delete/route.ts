    ...
    if (session.email) {
      ...
      await (
        ...
        payload: {
          ...
          html: `<p>Your ATLVS Technologies account is scheduled for permanent deletion on <strong>${formatDate(purgeAt, "short")}</strong>.</p><p>Sign in within that window to cancel the deletion. After 30 days all your data will be unrecoverable.</p>`,
        },
      });
    }
  }
