        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="mt-1 text-[11px] text-[var(--text-muted)]">
              Usable area: {formatNumber(Math.round(usableSqft))} sf at {selectedUse.sqftPerPerson} sf/person
            </div>
          </div>
          <div className="font-mono text-2xl font-semibold">{formatNumber(occupancy)}</div>
        </div>
      </div>
