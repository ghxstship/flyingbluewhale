...
export function KanbanCard({
  ...
  const base =
    "block w-full text-start bg-[var(--p-surface)] border-[3px] border-[var(--ink, var(--p-text-1))] rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--p-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--p-bg)]";
