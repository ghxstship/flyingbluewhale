...
const guests: GuideConfig = {
  ...
  preArrival: [
    ...
    'Small bags only — about the size of a standard clutch or small crossbody. Maximum 12" × 6" × 12". Backpacks and large purses are not permitted. Clear bags get you through the line faster.',
