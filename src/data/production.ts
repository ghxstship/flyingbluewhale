...
const production: GuideConfig = {
  ...
  rideshare: 'Rideshare is not the recommended arrival method for production crew. If necessary, have your driver drop you at the E 32nd St Production Gate — not the guest entrance on E 4th Ave.',
  ...
  roleFAQ: [
    ...
    { question: 'Where do I park?', answer: 'Crew Parking is in the designated lot accessed from the Production Gate on E 32nd St. Display your vehicle placard on the dashboard. Do not park in guest lots.' },
