...
export const CREDENTIAL_MATRIX: CredentialRow[] = [
  ...
  { credential: 'Grandstand Table', commandCenter: false, backOfHouse: false, stage: false, backstage: false, vipStageTableNorth: false, vipStageTableSouth: false, vipBackstage: true, vipClubhouse: true, vipDanceFloor: true, grandstandsGA: true },
...
export const GUEST_FAQ: FAQPair[] = [
  ...
  { question: 'Is there a smoking area?', answer: 'Yes. Designated smoking areas are located near the parking lot perimeter. Smoking is not permitted inside any building or in the GA or VIP areas.' },
...
export const ASSEMBLY_POINT = 'Parking Zone C';
