...
export const COMMUNITY: Record<string, CaseStudy> = {
  ...
  "live-events-inc": {
    ...
    hero: "Live Events Inc. is a 22-person corporate activation agency running 40–60 shows a year. They migrated to the ATLVS Technologies suite to kill their internal duct tape. The invoicing cycle compression was the surprise.",
    stats: [
  ...
  "touring-agency": {
    ...
    blurb: "40+ shows/year, one advancing flow + artist portal for every artist on roster.",
    ...
    stats: [
      ...
      { value: "8", label: "Artists on one roster" },
