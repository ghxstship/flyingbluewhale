...
export const COMPARE: Record<string, CompareConfig> = {
  asana: {
    slug: "asana",
    competitor: "Asana",
    headline: "flyingbluewhale vs. Asana: production-native vs. generic work management.",
    ...
    bottomLine: "If you run shows, you'll outgrow Asana by your fifth event. flyingbluewhale is the production-native spine that doesn't need augmentation.",
    features: [
    ...
    whenTheyWin: [
      ...
      "You have deep Asana integrations (Salesforce, Jira) that depend on its project graph. Those flows stay on Asana; consider flyingbluewhale for just the production-adjacent work.",
    ],
    quote: {
      text: "We used Asana for four years. We didn't hate it — we just kept adding tools around it. flyingbluewhale replaced the tools around it and made the center redundant.",
    ...
    faqs: [
      {
        ...
        a: "Yes. CSV export from Asana maps cleanly to flyingbluewhale projects, milestones, and tasks. Custom fields map to our custom fields. Comments and attachments port over. A 50-project migration runs in under a day once the export is in hand.",
      },
      {
        q: "What if my team lives in Asana for non-event work?",
        a: "Keep them there. Run production-adjacent work on flyingbluewhale. The webhooks API at /api/v1/webhooks makes it easy to pipe status changes between the two; we have a sample adapter.",
      },
      {
        q: "Is pricing really unlimited users?",
        a: "Yes. Professional is $199/month per org, unlimited users. Asana Business is $24.99/user/month — a 10-person team is $3,000/year. A 20-person team is $6,000/year. flyingbluewhale Professional is $2,388/year regardless.",
      },
    ],
    keywords: ["flyingbluewhale vs asana", "event production vs asana", "asana alternative for events"],
  },

  monday: {
    slug: "monday",
    competitor: "Monday.com",
    headline: "flyingbluewhale vs. Monday.com: typed primitives vs. a pretty spreadsheet.",
    ...
    whyWeWin: [
      { title: "Typed, not freeform", body: "A deliverable in flyingbluewhale is a typed entity — tech rider, hotel block, insurance cert. Monday columns are freeform. Typed primitives prevent the 'which column is status this quarter?' drift." },
    ...
    migration: [
      ...
      "Monday automations → flyingbluewhale webhooks; we provide a mapping doc",
    ],
    faqs: [
      {
        q: "Can flyingbluewhale do everything Monday can?",
      ...
      },
      {
        ...
        a: "Monday Standard is $12/user/month. A 15-person production team is $2,160/year. Professional on flyingbluewhale is $2,388/year unlimited users — roughly the same headline price but every stakeholder beyond the 15 is free on our side, paid on theirs.",
      },
    ],
    keywords: ["flyingbluewhale vs monday", "monday alternative events", "production software vs monday.com"],
  },

  spreadsheets: {
    slug: "spreadsheets",
    competitor: "Spreadsheets",
    headline: "flyingbluewhale vs. spreadsheets: when the duct tape starts costing more than software.",
    ...
    whenTheyWin: [
      ...
      "You have a specific model we don't support (custom financial waterfall, proprietary scheduling algorithm). Keep the spreadsheet for that, move the rest to flyingbluewhale.",
    ],
    migration: [
