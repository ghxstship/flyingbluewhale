...
// Catalog kinds — the things you can assign to a party. The pure vocabulary
// lives in ./catalog-kinds (no `server-only`) so client components can import
// it; imported here (for this module's own use) and re-exported for server
...
export { CATALOG_KINDS, CATALOG_KIND_LABEL, CATALOG_KIND_LABEL_SINGULAR, type CatalogKind };
