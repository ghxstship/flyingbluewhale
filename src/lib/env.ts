...
export const env = schema.parse({
  ...
  FLAGS_API_HOST: process.env.FLAGS_API_HOST,
  NEXT_PUBLIC_FLAGS_CLIENT_KEY: process.env.NEXT_PUBLIC_FLAGS_CLIENT_KEY,
...
export const hasRemoteFlags = Boolean(env.NEXT_PUBLIC_FLAGS_CLIENT_KEY);
