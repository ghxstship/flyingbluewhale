...
export type GuideSection =
  | {
      ...
      heading: string;
      body: string;
      callouts?: { kind: "pink" | "gold" | "red"; title?: string; body: string }[];
    }
  | {
      type: "schedule";
      heading: string;
      entries: { time: string; activity: string; location?: string; note?: string }[];
    }
  ...
  | {
      type: "credentials";
      heading: string;
      rows: { area: string; access: Record<string, boolean | string> }[];
      columns: string[];
  ...
  | {
      type: "contacts";
      heading: string;
      entries: { header?: string; role?: string; name?: string; phone?: string; email?: string }[];
    }
  ...
  | {
      ...
      codeWords?: { code: string; meaning: string }[];
    }
