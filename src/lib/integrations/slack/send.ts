...
/** Look up the slack_user_links row for a LYTEHAUS user. */
...
/**
 * Send a DM to the LYTEHAUS user (by their `users.id`).
 *
 * Resolution chain:
...
/**
 * Slack `users.lookupByEmail` — used by "Auto-detect" to map a LYTEHAUS
