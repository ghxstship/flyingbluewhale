...
function renderPortalSlugNotFound(slug: string): string {
  ...
  return [
    ...
    `a.ps-btn{background:#5b9dff;color:#0a0c10}`,
    `a.ps-btn ps-btn--ghost{background:transparent;color:#e7e7ec;border:1px solid #2a3142}`,
    "</style>",
    "</head>",
    "<body>",
    "<main>",
    ...
    '<div class="actions">',
    '<a class="ps-btn" href="/">Home</a>',
    '<a class="ps-btn ps-btn--ghost" href="/contact">Contact Us</a>',
    "</div>",
    "</div>",
    "</main>",
    "</body>",
